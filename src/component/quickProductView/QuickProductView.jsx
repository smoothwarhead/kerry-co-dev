...
function QuickProductView({ CloseQuickView, detail }) {
	return (
		<>
			{detail.map((det) => (
				<div className="product-quick-view-overlay" key={det.id}>
					<div className="product-quick-view-container">
						<div className="product-quick-view">
							...
							<div className="product-quick-view-image-display">
								<img src={det.image} alt={det.alt} />
							</div>
